...
public class JasperCtl {
	...
	public void display(HttpServletRequest request, HttpServletResponse response) throws JRException, SQLException, IOException {
		...
		String path = context.getRealPath("D:\\rays\\sumit_proj0\\ors_proj0\\src\\main\\webapp\\WEB-INF\\Cherry.jrxml");
		System.out.println("in jasper");
		Connection con = null;
		JasperReport jasperReport = JasperCompileManager.compileReport("D:\\rays\\sumit_proj0\\ors_proj0\\src\\main\\webapp\\WEB-INF\\Cherry.jrxml");
